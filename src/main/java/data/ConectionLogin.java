...
public class ConectionLogin extends ConectionData {
    private static final String DB_URL = "jdbc:mysql://181.226.106.35:3306/Login";
    private static final String USER = "root";
    private static final String PASS = "0208";


    public ConectionLogin() throws SQLException {
        super();
        conectar();
    }
    ...
    private ResultSet buscarUsuario(String rut, String pass) throws SQLException {

        var datosCliente = new ConectionLogin();
